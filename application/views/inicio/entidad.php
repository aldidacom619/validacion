...
<ul class="nav nav-tabs" >
    <li class="active"><a href="<?php echo base_url()?>index.php/Entidadesd" class="validar">DECLARAN</a></li>
    <li><a href="<?php echo base_url()?>index.php/Entidadesd/entidadesbaja"  >NO DECLARAN</a></li>
</ul>
<div class="contenido">
    <h2 class="label label-info" style="font-size: 1.15em; width: 25%;">Listado de Entidades A Declarar</h2>
</div>
<div class="row">
    <div class="col-lg-12">
